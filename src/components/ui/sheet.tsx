...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn("fixed inset-0 z-50 bg-black bg-opacity-10 backdrop-blur-sm", className)}
    {...props}
    ref={ref}
  />
));
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref} className={cn("text-lg font-semibold text-neutral-950", className)} {...props} />
));
